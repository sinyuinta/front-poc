...
import { getTargets } from "./lib/personaApi";
import { explainLineEval as explainLineEvalApi } from "./lib/personaApi";
import { FlowScreen } from "./ms/flow_screen.jsx";   // ← ここに追加
import "./App.css";   // ← これを追加
import {checkLogBias, getNoise, arrangeBoard ,evidenceQuest,getTeamState,updateTeamState,subscribePlan } from "./lib/personaApi";
import kobusiImg from "./imgs/kobusi.png";
...
const exportPDF = async () => {
  const element = document.body; // 画面全部をPDF化
...
const [showLogin, setShowLogin] = useState(false);
  const [userToken, setUserToken] = useState(localStorage.getItem("shikoUserToken"));
  ...
  <div className={`introWrap ${stage}`}>
    ...
    <div className="homeContent">
      <h1 className="mainTitle">
        思考アスレチック工事中<span className="tm">®</span>
      </h1>
